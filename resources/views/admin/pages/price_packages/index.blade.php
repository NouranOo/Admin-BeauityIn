...
<div class="modal fade" id="add_package" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content text-center">
            ...
            <form action="{{ url ('addPrivePackage')}}" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" placeholder="type" type="text"  name="description">
                    </div>
                    <!-- <div class="col-md-6 form-group">
...
<div class="content">
    ...
    <div class="col-sm-12">
        <button  data-toggle="modal" data-target="#add_package" action="{{ url('addPrivePackage') }}" class="custom-btn green-bc">
